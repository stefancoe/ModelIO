        ...
        Try
            ...
            Do Until pHOVFeat Is Nothing
                ...
                Do Until pJNodeFeat Is Nothing
                    ...
                    'looking for a different facility type, e.g. ramp and must have GP lanes
                    If pJNodeFeat.Value(indexFacType) <> pHOVfeatFacType And (pRow.Value(pRow.Fields.FindField("IJLanesGPAM")) Or pRow.Value(pRow.Fields.FindField("JILanesGPAM")) > 0) Then
                ...
                Do Until pINodeFeat Is Nothing
                    ...
                    pRow = pModeCursor.NextRow
                    'looking for a different facility type, e.g. ramp and must have GP lanes
                    If pINodeFeat.Value(indexFacType) <> pHOVfeatFacType And (pRow.Value(pRow.Fields.FindField("IJLanesGPAM")) Or pRow.Value(pRow.Fields.FindField("JILanesGPAM")) > 0) Then
                        'get the connected feature's Inode
